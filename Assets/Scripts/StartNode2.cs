...
public class StartNode2 : MonoBehaviour
{
    
    [SerializeField] private GameObject connectedNode;
    [SerializeField] private PowerLineManager2 connectedManager;
    ...
    void Start()
    {
        connectedManager = connectedNode.GetComponent<PowerLineManager2>();
    }
